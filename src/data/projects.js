...
const PROJECTS = [
    {
        ...
        client: "MobileForce Software Inc. (USA)",
        teamSize : 6,
    ...
    },
    {
        ...
        description: "VOPS that provides a great fleet tracking & management tool with a click. When your vehicles are on the road, it feels like they’re off the grid. I remove all those unknowns and put you in control through VOPS, a GPS fleet tracking , management & monitoring tool. With GPS tracker VOPS harness the power of TransportHub driver and fleet tracking app DriverHOOQ. I help you monitor the vehicles in your truck fleet , receive data from them, analyse it, and provide timely solutions for timely decisions on fuelling, maintenance, routing and even driver management",
